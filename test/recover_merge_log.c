...
static void
test_recover_merge_log_replace_get0(void)
{
	rmrf("./test");
	rmrf("./log");
...
static void
test_recover_merge_log_replace_get1(void)
{
	rmrf("./test");
	rmrf("./log");
...
static void
test_recover_merge_log_set_replace_get0(void)
{
	rmrf("./test");
	rmrf("./log");
...
static void
test_recover_merge_log_set_replace_get1(void)
{
	rmrf("./test");
	rmrf("./log");
...
static void
test_recover_merge_log_fetch_gt(void)
{
	rmrf("./test");
	rmrf("./log");
...
static void
test_recover_merge_log_fetch_lt(void)
{
	rmrf("./test");
	rmrf("./log");
...
{
	test( test_recover_merge_log_replace_get0 );
	test( test_recover_merge_log_replace_get1 );
	test( test_recover_merge_log_set_replace_get0 );
	test( test_recover_merge_log_set_replace_get1 );
	test( test_recover_merge_log_fetch_gte );
	test( test_recover_merge_log_fetch_gt );
	test( test_recover_merge_log_fetch_lte );
	test( test_recover_merge_log_fetch_lt );
	return 0;
}
