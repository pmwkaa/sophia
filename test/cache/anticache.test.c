...
anticache_promote0(void)
{
	...
	t( sp_setint(env, "db.test.memory_limit_anticache", 100 * 1024 * 1024) == 0 );
	...
	t( sp_getint(env, "db.test.scheduler.anticache") == 0 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn") == 0 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn_last") == 0 );

	t( sp_setint(env, "db.test.compaction.anticache", 0) == 0 );

	t( sp_getint(env, "db.test.scheduler.anticache") == 1 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn") == 1 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn_last") == 0 );
	...
	t( sp_getint(env, "db.test.scheduler.anticache") == 0 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn") == 0 );
	t( sp_getint(env, "db.test.scheduler.anticache_asn_last") == 1 );
