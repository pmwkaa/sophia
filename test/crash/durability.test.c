...
durability_build0(void)
{
	...
	t( exists(st_r.conf->db_dir, "00000000000000000001.db") == 1 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.incomplete") == 1 );
...
durability_compact0(void)
{
	...
	t( exists(st_r.conf->db_dir, "00000000000000000001.db") == 1 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.incomplete") == 0 );
}
...
durability_compact1(void)
{
	...
	t( exists(st_r.conf->db_dir, "00000000000000000001.db") == 1 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.incomplete") == 0 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.seal") == 1 );
	...
	t( exists(st_r.conf->db_dir, "00000000000000000001.db") == 0 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.incomplete") == 0 );
	t( exists(st_r.conf->db_dir, "00000000000000000001.00000000000000000002.db.seal") == 0 );
	t( exists(st_r.conf->db_dir, "00000000000000000002.db") == 1 );
}
